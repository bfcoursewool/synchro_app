...
buffer=chars.indexOf(buffer);}return output;});})();});/* global global */var globalNamespace=void 0;if(typeof global==='undefined'){globalNamespace=window;}else{globalNamespace=global;}function set(key,value){if(!globalNamespace[key]){globalNamespace[key]=value;}}function get(key){return globalNamespace[key];}var globalVars={set:set,get:get};// drop in polyfills from base64
...
return true;}index++;}return false;};}else{includes=function includes(array){var args=[].slice.call(arguments,1);return Array.prototype.includes.apply(array,args);};}var includes$1=includes;function wrap(func,superFunc){function superWrapper(){var originalSuper=this['super'];this['super']=function(){return superFunc.apply(this,arguments);};var ret=func.apply(this,arguments);this['super']=originalSuper;return ret;}superWrapper.wrappedFunction=func;return superWrapper;}function defineProperties$1(names,proto,destination){var parentProto=Object.getPrototypeOf(destination);names.forEach(function(name){var descriptor=Object.getOwnPropertyDescriptor(proto,name);var parentDescriptor=parentProto.hasOwnProperty(name)&&Object.getOwnPropertyDescriptor(parentProto,name);if(typeof parentDescriptor.value==='function'&&typeof descriptor.value==='function'){var wrappedFunction=wrap(descriptor.value,parentDescriptor.value);Object.defineProperty(destination,name,{value:wrappedFunction});}else{Object.defineProperty(destination,name,descriptor);}});}function createClass(props){var parent=arguments.length>1&&arguments[1]!==undefined?arguments[1]:Object;var Constructor=wrap(props.constructor,parent);var instancePropertyNames=Object.getOwnPropertyNames(props).filter(function(key){return!includes$1(['constructor','static'],key);});assign$1(Constructor,parent);Constructor.prototype=Object.create(parent.prototype);defineProperties$1(instancePropertyNames,props,Constructor.prototype);Constructor.prototype.constructor=Constructor;var staticProps=props['static'];if(staticProps){var staticPropertyNames=Object.getOwnPropertyNames(staticProps);defineProperties$1(staticPropertyNames,staticProps,Constructor);}return Constructor;}var CoreObject=createClass({constructor:function constructor(){},'static':{extend:function extend(subClassProps){return createClass(subClassProps,this);}}});function wrapConsole(logCommand){var logMethod=function logMethod(){var log=void 0;/* eslint-disable no-console */if(console[logCommand]){log=Function.prototype.bind.call(console[logCommand],console);}else{log=Function.prototype.bind.call(console.log,console);}log.apply(undefined,arguments);/* eslint-enable no-console */};return function(){var args=[].concat(Array.prototype.slice.call(arguments));args.unshift('[JS-BUY-SDK]: ');logMethod.apply(undefined,_toConsumableArray(args));};}var Logger=CoreObject.extend({/**
   ...
   */myShopifyDomain:''});var version$1='v0.5.1-e503716';// eslint-disable-line
...
*/var ProductOptionModel=BaseModel.extend(Object.defineProperties({constructor:function constructor(){this['super'].apply(this,arguments);this.selected=this.values[0];}},{name:{/**
  ...
  */get:function get(){return this.attrs.values;},configurable:true,enumerable:true},selected:{/**
    ...
    * @property selected
    * @type String
  */get:function get(){return this._selected;},set:function set(value){if(includes$1(this.values,value)){this._selected=value;}else{throw new Error('Invalid option selection for '+this.name+'.');}return value;},configurable:true,enumerable:true}}));/**
...
*/var ProductVariantModel=BaseModel.extend(Object.defineProperties({constructor:function constructor(){this['super'].apply(this,arguments);},/**
  ...
  */checkoutUrl:function checkoutUrl(){var quantity=arguments.length>0&&arguments[0]!==undefined?arguments[0]:1;var config=this.config;var baseUrl='https://'+config.domain+'/cart';var variantPath=this.id+':'+parseInt(quantity,10);var query='api_key='+config.apiKey;return baseUrl+'/'+variantPath+'?'+query;}},{id:{/**
    * Variant unique ID
    * @property id
    * @type {String}
  ...
  */get:function get(){return this.attrs.variant.available;},configurable:true,enumerable:true},image:{/**
    ...
    * @property image
    * @type {Object}
  */get:function get(){var id=this.id;var images=this.attrs.product.images;var primaryImage=images[0];var variantImage=images.filter(function(image){return image.variant_ids.indexOf(id)!==-1;})[0];return variantImage||primaryImage;},configurable:true,enumerable:true},imageVariants:{/**
 ...
 */var ProductModel=BaseModel.extend(Object.defineProperties({constructor:function constructor(){this['super'].apply(this,arguments);}},{id:{/**
  ...
  */get:function get(){return this.attrs.images;},configurable:true,enumerable:true},memoized:{get:function get(){this._memoized=this._memoized||{};return this._memoized;},configurable:true,enumerable:true},options:{/**
   ...
   */get:function get(){if(this.memoized.options){return this.memoized.options;}var baseOptions=this.attrs.options;var variants=this.variants;this.memoized.options=baseOptions.map(function(option){var name=option.name;var dupedValues=variants.reduce(function(valueList,variant){var optionValueForOption=variant.optionValues.filter(function(optionValue){return optionValue.name===option.name;})[0];valueList.push(optionValueForOption.value);return valueList;},[]);var values=uniq(dupedValues);return new ProductOptionModel({name:name,values:values});});return this.memoized.options;},configurable:true,enumerable:true},variants:{/**
  ...
  */get:function get(){var _this2=this;return this.attrs.variants.map(function(variant){return new ProductVariantModel({variant:variant,product:_this2},{config:_this2.config});});},configurable:true,enumerable:true},selections:{/**
 ...
 */var CartLineItemModel=BaseModel.extend(Object.defineProperties({constructor:function constructor(){this['super'].apply(this,arguments);}},{id:{/**
   ...
   * @readOnly
   * @type {Object}
   */get:function get(){return this.attrs.image;},configurable:true,enumerable:true},imageVariants:{/**
    * Image variants available for a variant. An example value of `imageVariant`:
    * ```
    * [
    *   {
    ...
    * @property imageVariant
    * @type {Array}
  */get:function get(){return this.attrs.image_variants;},configurable:true,enumerable:true},title:{/**
...
this.attrs.line_items=dedupedLineItems.reduce(function(itemAcc,item){if(item.quantity>=1){itemAcc.push(item);}return itemAcc;},[]);return this.updateModel();},/**
  ...
  */clearLineItems:function clearLineItems(){this.attrs.line_items=[];return this.updateModel();},/**
    ...
    * @public
    * @return {Promise|CartModel} - the cart instance
  */updateModel:function updateModel(){var _this4=this;return this.shopClient.update('carts',this).then(function(updateCart){assign$1(_this4.attrs,updateCart.attrs);return _this4;});}},{id:{/**
 ...
 */function fetchFactory(fetchType,type){var func=void 0;switch(fetchType){case'all':func=function func(){return this.fetchAll(type);};break;case'one':func=function func(){return this.fetch.apply(this,[type].concat(Array.prototype.slice.call(arguments)));};break;case'query':func=function func(){return this.fetchQuery.apply(this,[type].concat(Array.prototype.slice.call(arguments)));};break;}return func;}var ShopClient=CoreObject.extend(Object.defineProperties({/**
   ...
   */fetchAll:function fetchAll(type){var _this8=this;var adapter=new this.adapters[type](this.config);return adapter.fetchMultiple(type).then(function(payload){return _this8.deserialize(type,payload,adapter,null,{multiple:true});});},/**
   ...
   */fetch:function fetch(type,id){var _this9=this;var adapter=new this.adapters[type](this.config);return adapter.fetchSingle(type,id).then(function(payload){return _this9.deserialize(type,payload,adapter,null,{single:true});});},/**
   ...
   * @return {Promise|Array} a promise resolving with an array of `type`.
   */fetchQuery:function fetchQuery(type,query){var _this10=this;var adapter=new this.adapters[type](this.config);return adapter.fetchMultiple(type,query).then(function(payload){return _this10.deserialize(type,payload,adapter,null,{multiple:true});});},/**
   ...
   * @return {Promise|CartModel} a promise resolving with a single instance of
   * `type`
   */update:function update(type,updatedModel){var _this12=this;var adapter=updatedModel.adapter;var serializer=updatedModel.serializer;var serializedModel=serializer.serialize(type,updatedModel);var id=updatedModel.attrs[adapter.idKeyForType(type)];return adapter.update(type,id,serializedModel).then(function(payload){return _this12.deserialize(type,payload,adapter,serializer,{single:true});});},/**
  ...
  */updateCart:function updateCart(updatedCart){return this.update('carts',updatedCart);},/**
   ...
   */fetchRecentCart:function fetchRecentCart(){var _this13=this;return this.fetch('references',this.config.domain+'.recent-cart').then(function(reference){var cartId=reference.referenceId;return _this13.fetchCart(cartId);})['catch'](function(){return _this13.createCart().then(function(cart){var refAttrs={referenceId:cart.id};refAttrs[GUID_KEY]=_this13.config.domain+'.recent-cart';_this13.create('references',refAttrs);return cart;});});}},{serializers:{/**
   * @attribute
   * @default {
...
var _polyfilled = require('shopify-buy/polyfilled');
...
window.ShopifyBuy = window.ShopifyBuy || _polyfilled2.default;

_polyfilled2.default.UI = window.ShopifyBuy.UI || {
  domains: {},
  ...
  init: function init(client) {
    ...
    if (!this.domains[domain]) {
      this.domains[domain] = new _ui2.default(client, integrations, styleOverrides);
    }
...
exports.default = _polyfilled2.default;

},{"./templates/product":28,"./ui":31,"shopify-buy/polyfilled":7}],9:[function(require,module,exports){
'use strict';
...
var _logNotFound = require('./utils/log-not-found');

var _logNotFound2 = _interopRequireDefault(_logNotFound);

var _logger = require('./utils/logger');

var _logger2 = _interopRequireDefault(_logger);

var _moneyFormat = require('./defaults/money-format');
...
function moneyFormat() {
  var format = arguments.length <= 0 || arguments[0] === undefined ? _moneyFormat2.default : arguments[0];
...
var Component = function () {
  ...
  function Component(config, props) {
    ...
    this.config = (0, _merge2.default)({}, _components2.default, config.options || {});
    this.props = props;
    this.model = {};
    this.updater = new _updater2.default(this);
  ...
  Component.prototype._userEvent = function _userEvent(methodName) {
    if (this.globalConfig.debug) {
      _logger2.default.info('EVENT: ' + methodName + ' (' + this.typeKey + ')');
    }
    if ((0, _isFunction2.default)(this.events[methodName])) {
  ...
  _createClass(Component, [{
    ...
    key: 'options',
    get: function get() {
      return (0, _merge2.default)({}, this.config[this.typeKey]);
    }
    ...
    key: 'viewData',
    get: function get() {
      return (0, _merge2.default)(this.model, this.options.viewData, {
...
},{"./defaults/components":16,"./defaults/money-format":17,"./updater":32,"./utils/is-function":40,"./utils/log-not-found":41,"./utils/logger":42,"./utils/merge":43,"./view":48}],10:[function(require,module,exports){
'use strict';
...
var _merge2 = require('../utils/merge');
...
var _cart3 = require('../updaters/cart');
...
var Cart = function (_Component) {
  ...
  function Cart(config, props) {
    ...
    _this.childTemplate = new _template2.default(_this.config.lineItem.templates, _this.config.lineItem.contents, _this.config.lineItem.order);
    _this.node = config.node || document.body.appendChild(document.createElement('div'));
    _this.isVisible = _this.options.startOpen;
    _this.checkout = new _checkout2.default(_this.config);
    ...
    _this.toggles = toggles.map(function (toggle) {
      return new _toggle2.default((0, _merge3.default)({}, config, toggle), _extends({}, _this.props, { cart: _this }));
    });
    _this.updater = new _cart4.default(_this);
    _this.view = new _cart2.default(_this);
    return _this;
  }
  ...
  Cart.prototype.createToggles = function createToggles(config) {
    ...
    this.toggles = this.toggles.concat(config.toggles.map(function (toggle) {
      return new _toggle2.default((0, _merge3.default)({}, config, toggle), _extends({}, _this2.props, { cart: _this2 }));
    }));
  ...
  _createClass(Cart, [{
    ...
    get: function get() {
      ...
      return (0, _merge3.default)({}, (_merge = {}, _defineProperty(_merge, 'click ' + this.selectors.cart.close, this.props.closeCart.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.lineItem.quantityIncrement, this.onQuantityIncrement.bind(this, 1)), _defineProperty(_merge, 'click ' + this.selectors.lineItem.quantityDecrement, this.onQuantityIncrement.bind(this, -1)), _defineProperty(_merge, 'click ' + this.selectors.cart.button, this.onCheckout.bind(this)), _defineProperty(_merge, 'blur ' + this.selectors.lineItem.quantityInput, this.onQuantityBlur.bind(this)), _merge), this.options.DOMEvents);
    }
    ...
    get: function get() {
      ...
      return this.model.lineItems.reduce(function (acc, lineItem) {
        var data = (0, _merge3.default)(lineItem, _this7.options.viewData);
        ...
        data.formattedPrice = (0, _money2.default)(data.line_price, _this7.globalConfig.moneyFormat);
    ...
    key: 'viewData',
    get: function get() {
      return (0, _merge3.default)(this.model, this.options.viewData, {
        text: this.options.text,
        classes: this.classes,
    ...
    key: 'formattedTotal',
    get: function get() {
      return (0, _money2.default)(this.model.subtotal, this.globalConfig.moneyFormat);
    }
...
},{"../component":9,"../template":23,"../updaters/cart":33,"../utils/merge":43,"../utils/money":44,"../views/cart":49,"./checkout":11,"./toggle":15}],11:[function(require,module,exports){
'use strict';
...
var _modal3 = require('../updaters/modal');
...
var Modal = function (_Component) {
  ...
  function Modal(config, props) {
    ...
    _this.product = null;
    _this.updater = new _modal4.default(_this);
    _this.view = new _modal2.default(_this);
    return _this;
  }
  ...
  */
  ...
  Modal.prototype.init = function init(data) {
    ...
    return _Component.prototype.init.call(this, data).then(function () {
      ...
      _this2.product = new _product2.default(_this2.productConfig, _this2.props);
  ...
  _createClass(Modal, [{
    key: 'DOMEvents',
    get: function get() {
      return _extends({}, _defineProperty({}, 'click ' + this.selectors.modal.close, this.props.closeModal.bind(this)), this.options.DOMEvents);
    }
    ...
    get: function get() {
      return _extends({}, this.globalConfig, {
        ...
        options: (0, _merge2.default)({}, this.config)
      });
    }
  }]);
...
},{"../component":9,"../updaters/modal":34,"../utils/merge":43,"../views/modal":50,"./product":14}],13:[function(require,module,exports){
'use strict';
...
var _productSet = require('../updaters/product-set');

var _productSet2 = _interopRequireDefault(_productSet);

var _productSet3 = require('../views/product-set');

var _productSet4 = _interopRequireDefault(_productSet3);
...
var ProductSet = function (_Component) {
  _inherits(ProductSet, _Component);
  ...
  function ProductSet(config, props) {
    ...
    _this.updater = new _productSet2.default(_this);
    _this.view = new _productSet4.default(_this);
    return _this;
  }
  ...
  ProductSet.prototype.sdkFetch = function sdkFetch() {
    ...
    if (this.id) {
      ...
      method = this.props.client.fetchQueryProducts(_extends({}, queryOptions, _defineProperty({}, queryKey, this.id)));
    } else if (this.handle) {
  ...
  ProductSet.prototype.renderProducts = function renderProducts() {
    ...
    var promises = this.model.products.map(function (productModel) {
      var product = new _product2.default(productConfig, _this5.props);
  ...
  _createClass(ProductSet, [{
    ...
    get: function get() {
      this._paginationTemplate = this._paginationTemplate || new _template2.default({ pagination: this.options.templates.pagination }, { pagination: true }, ['pagination']);
...
},{"../component":9,"../template":23,"../updaters/product-set":35,"../utils/merge":43,"../views/product-set":51,"./product":14}],14:[function(require,module,exports){
'use strict';
...
var _windowUtils = require('../utils/window-utils');
...
var _product3 = require('../updaters/product');
...
var Product = function (_Component) {
  ...
  function Product(config, props) {
    ...
    _this.childTemplate = new _template2.default(_this.config.option.templates, _this.config.option.contents, _this.config.option.order);
    _this.cart = null;
    _this.modal = null;
    _this.imgStyle = '';
    _this.selectedQuantity = 1;
    _this.updater = new _product4.default(_this);
    _this.view = new _product2.default(_this);
    return _this;
  }
  ...
  Product.prototype.optionValueCanBeSelected = function optionValueCanBeSelected(selections, name, value) {
    ...
    var selectableValues = _extends({}, selections, _defineProperty({}, name, value));
  ...
  Product.prototype.onButtonClick = function onButtonClick(evt, target) {
    ...
    if (this.options.buttonDestination === 'cart') {
      ...
      this._userEvent('openCheckout');
      new _checkout2.default(this.config).open(this.model.selectedVariant.checkoutUrl(this.selectedQuantity));
    }
  };
  ...
  Product.prototype.setDefaultVariant = function setDefaultVariant(model) {
    ...
    var selectedVariant = model.variants.filter(function (variant) {
      return variant.id === _this4.defaultVariantId;
    })[0];
    if (selectedVariant) {
  ...
  _createClass(Product, [{
    ...
    get: function get() {
      ...
      return (0, _money2.default)(this.model.selectedVariant.price, this.globalConfig.moneyFormat);
    }
    ...
    get: function get() {
      ...
      return (0, _money2.default)(this.model.selectedVariant.compareAtPrice, this.globalConfig.moneyFormat);
    }
    ...
    get: function get() {
      ...
      return (0, _merge3.default)({}, (_merge = {
        click: this.closeCartOnBgClick.bind(this)
      }, _defineProperty(_merge, 'click ' + this.selectors.option.select, this.stopPropagation.bind(this)), _defineProperty(_merge, 'focus ' + this.selectors.option.select, this.stopPropagation.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.option.wrapper, this.stopPropagation.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.product.quantityInput, this.stopPropagation.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.product.quantityButton, this.stopPropagation.bind(this)), _defineProperty(_merge, 'change ' + this.selectors.option.select, this.onOptionSelect.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.product.button, this.onButtonClick.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.product.blockButton, this.onButtonClick.bind(this)), _defineProperty(_merge, 'keyup ' + this.selectors.product.blockButton, this.onBlockButtonKeyup.bind(this)), _defineProperty(_merge, 'click ' + this.selectors.product.quantityIncrement, this.onQuantityIncrement.bind(this, 1)), _defineProperty(_merge, 'click ' + this.selectors.product.quantityDecrement, this.onQuantityIncrement.bind(this, -1)), _defineProperty(_merge, 'blur ' + this.selectors.product.quantityInput, this.onQuantityBlur.bind(this)), _merge), this.options.DOMEvents);
    }
  }, {
    key: 'optionsHtml',
    get: function get() {
      ...
      return this.decoratedOptions.reduce(function (acc, option) {
        var data = (0, _merge3.default)(option, _this6.options.viewData);
        data.classes = _this6.classes;
        data.onlyOption = _this6.model.options.length === 1;

        return acc + _this6.childTemplate.render({ data: data });
      }, '');
    }
    ...
    get: function get() {
      ...
      this.model.selections.forEach(function (selection, index) {
        var option = _this7.model.options[index];
        ...
        return {
          ...
          values: option.values.map(function (value) {
            return {
              ...
              disabled: !_this8.optionValueCanBeSelected(selections, option.name, value)
            };
          })
        };
      });
    ...
    get: function get() {
      ...
      if (this.config.product.styles) {
        modalProductStyles = (0, _merge3.default)({}, Object.keys(this.config.product.styles).reduce(function (productStyles, selectorKey) {
          productStyles[selectorKey] = whitelistedProperties(_this9.config.product.styles[selectorKey]);
    ...
    get: function get() {
      return {
        channel: 'buy_button',
        referrer: encodeURIComponent(_windowUtils2.default.location()),
    ...
    get: function get() {
      ...
      return Object.keys(this.onlineStoreParams).reduce(function (string, key) {
        return '' + string + key + '=' + _this10.onlineStoreParams[key] + '&';
      }, '?');
    }
...
},{"../component":9,"../template":23,"../updaters/product":36,"../utils/merge":43,"../utils/money":44,"../utils/window-utils":47,"../views/product":52,"./checkout":11}],15:[function(require,module,exports){
'use strict';
...
var _toggle = require('../views/toggle');
...
var CartToggle = function (_Component) {
  _inherits(CartToggle, _Component);

  function CartToggle(config, props) {
    _classCallCheck(this, CartToggle);
    ...
    _this.view = new _toggle2.default(_this);
    return _this;
  }
...
},{"../component":9,"../utils/merge":43,"../views/toggle":53}],16:[function(require,module,exports){
'use strict';
...
var _toggle = require('../templates/toggle');
...
var _modal = require('../templates/modal');
...
},{"../templates/cart":24,"../templates/line-item":25,"../templates/modal":26,"../templates/option":27,"../templates/product":28,"../templates/toggle":30}],17:[function(require,module,exports){
'use strict';
...
exports.default = defaultMoneyFormat;
...
var _conditional = require('./styles/embeds/conditional');
...
var iframe = function () {
  ...
  _createClass(iframe, [{
    ...
    get: function get() {
      ...
      return _conditional2.default;
    }
  }, {
    key: 'css',
    get: function get() {
      var compiled = _mustache2.default.render(_styles2.default, { selectors: this.customStyles });
...
},{"./styles/embeds/conditional":20,"./templates/styles":29,"./utils/element-class":38,"mustache":6}],19:[function(require,module,exports){
'use strict';
...
exports.default = ".shopify-buy__modal {\n  display: none; }\n  .is-active .shopify-buy__modal {\n    display: block;\n    opacity: 1;\n    margin-left: auto;\n    margin-right: auto; }\n";
...
exports.default = ".shopify-buy-frame--cart {\n  display: none; }\n  .shopify-buy-frame--cart.is-active {\n    display: block; }\n";
...
var Template = function () {
  ...
  Template.prototype.render = function render(data, cb) {
    var output = _mustache2.default.render(this.masterTemplate, data);
    if (!cb) {
      return output;
    }
    return cb(output);
...
},{"mustache":6}],24:[function(require,module,exports){
"use strict";
...
exports.default = lineItemTemplates;
...
exports.default = modalTemplates;
...
exports.default = toggleTemplates;
...
var _productSet = require('./components/product-set');
...
var _host = require('./styles/host/host');

var _host2 = _interopRequireDefault(_host);

var _conditional = require('./styles/host/conditional');
...
var _detectFeatures = require('./utils/detect-features');

var _detectFeatures2 = _interopRequireDefault(_detectFeatures);
...
var UI = function () {
  ...
  function UI(client) {
    ...
    this.componentTypes = {
      product: _product2.default,
      cart: _cart2.default,
      collection: _productSet2.default,
      productSet: _productSet2.default,
      toggle: _toggle2.default
    };
    this.errorReporter = integrations.errorReporter;
    this.tracker = new _track2.default(integrations.tracker, this.client.config);
  ...
  UI.prototype.createCart = function createCart(config) {
    ...
    if (this.components.cart.length) {
      ...
      var cart = new _cart2.default(config, this.componentProps);
  ...
  UI.prototype.createModal = function createModal(config) {
    if (this.components.modal.length) {
      ...
      var modal = new _modal2.default(config, this.componentProps);
  ...
  UI.prototype._bindResize = function _bindResize() {
    ...
    (0, _throttle2.default)('resize', 'safeResize');
  ...
  _createClass(UI, [{
    ...
    get: function get() {
      return {
        ...
        browserFeatures: _detectFeatures2.default
      };
    }
    ...
    key: 'styleText',
    get: function get() {
      if (_detectFeatures2.default.transition && _detectFeatures2.default.transform && _detectFeatures2.default.animation) {
        return _host2.default + this.styleOverrides;
      }
      return _host2.default + _conditional2.default + this.styleOverrides;
    }
  }]);
...
},{"./components/cart":10,"./components/modal":12,"./components/product":14,"./components/product-set":13,"./components/toggle":15,"./styles/host/conditional":21,"./styles/host/host":22,"./utils/detect-features":37,"./utils/throttle":45,"./utils/track":46}],32:[function(require,module,exports){
'use strict';
...
var Updater = function () {
  ...
  Updater.prototype.updateConfig = function updateConfig(config) {
    this.component.config = (0, _merge2.default)(this.component.config, config.options);
    this.component.view.template = new _template2.default(this.component.options.templates, this.component.options.contents, this.component.options.order);
...
},{"./template":23,"./utils/merge":43}],33:[function(require,module,exports){
'use strict';
...
var CartUpdater = function (_Updater) {
  _inherits(CartUpdater, _Updater);

  function CartUpdater() {
    _classCallCheck(this, CartUpdater);
...
},{"../updater":32}],34:[function(require,module,exports){
'use strict';
...
var ModalUpdater = function (_Updater) {
  _inherits(ModalUpdater, _Updater);

  function ModalUpdater() {
    _classCallCheck(this, ModalUpdater);
  ...
  ModalUpdater.prototype.updateConfig = function updateConfig(config) {
    ...
    _Updater.prototype.updateConfig.call(this, config);
    this.component.product = new _product2.default(this.component.productConfig, this.component.props);
...
},{"../components/product":14,"../updater":32}],35:[function(require,module,exports){
'use strict';
...
var ProductSetUpdater = function (_Updater) {
  _inherits(ProductSetUpdater, _Updater);

  function ProductSetUpdater() {
    _classCallCheck(this, ProductSetUpdater);
...
},{"../updater":32}],36:[function(require,module,exports){
'use strict';
...
var ProductUpdater = function (_Updater) {
  _inherits(ProductUpdater, _Updater);

  function ProductUpdater() {
    _classCallCheck(this, ProductUpdater);
  ...
  ProductUpdater.prototype.updateConfig = function updateConfig(config) {
    ...
    [].concat(_toConsumableArray(this.component.view.wrapper.querySelectorAll('img'))).forEach(function (img) {
...
},{"../updater":32}],37:[function(require,module,exports){
'use strict';
...
},{"./logger":42}],42:[function(require,module,exports){
'use strict';
...
function formatMoney(amount, format) {
  ...
  var value = '';
  var formatString = format || _moneyFormat2.default;
  var placeholderMatch = formatString.match(placeholderRegex);

  if (!placeholderMatch) {
    formatString = _moneyFormat2.default;
...
},{"../defaults/money-format":17}],45:[function(require,module,exports){
'use strict';
...
var _frameUtils = require('./frame-utils');

var _frameUtils2 = _interopRequireDefault(_frameUtils);
...
var throttle = function throttle(type, name, obj) {
  ...
  var func = function func() {
    ...
    running = true;
    _frameUtils2.default.requestAnimationFrame.call(window, function () {
...
},{"./frame-utils":39}],46:[function(require,module,exports){
'use strict';
...
var _all = require('./styles/embeds/all');
...
var View = function () {
  function View(component) {
    ...
    this.template = new _template2.default(this.component.options.templates, this.component.options.contents, this.component.options.order);
  }
  ...
  View.prototype.init = function init() {
    ...
    this.iframe = new _iframe2.default(this.component.node, {
      classes: this.component.classes,
      customStyles: this.component.styles,
      stylesheet: _all2.default[this.component.typeKey],
  ...
  View.prototype.updateNode = function updateNode(node, html) {
    var div = document.createElement('div');
    div.innerHTML = html;
    (0, _morphdom2.default)(node, div.firstElementChild);
  };
...
},{"./iframe":18,"./styles/embeds/all":19,"./template":23,"./utils/element-class":38,"morphdom":5}],49:[function(require,module,exports){
'use strict';
...
var CartView = function (_View) {
  ...
  function CartView(component) {
    ...
    var _this = _possibleConstructorReturn(this, _View.call(this, component));
...
},{"../view":48}],50:[function(require,module,exports){
'use strict';
...
},{"../utils/element-class":38,"../view":48}],51:[function(require,module,exports){
'use strict';
...
var ProductSetView = function (_View) {
  _inherits(ProductSetView, _View);

  function ProductSetView(component) {
    _classCallCheck(this, ProductSetView);
...
},{"../view":48}],52:[function(require,module,exports){
'use strict';
...
var ProductView = function (_View) {
  ...
  ProductView.prototype.wrapTemplate = function wrapTemplate(html) {
    ...
    if (this.component.options.isButton) {
...
},{"../view":48}],53:[function(require,module,exports){
'use strict';
